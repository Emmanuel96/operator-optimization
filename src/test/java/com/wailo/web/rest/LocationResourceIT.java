...
class LocationResourceIT {
    ...
    private static final String DEFAULT_UWI = "AAAAAAAAAA";
    private static final String UPDATED_UWI = "BBBBBBBBBB";
    ...
    private static final LocationType DEFAULT_TYPE = LocationType.WELL;
    private static final LocationType UPDATED_TYPE = LocationType.PLANT;
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getUwi()).isEqualTo(DEFAULT_UWI);
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].uwi").value(hasItem(DEFAULT_UWI)))
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.uwi").value(DEFAULT_UWI))
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.name(UPDATED_NAME).uwi(UPDATED_UWI).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).type(UPDATED_TYPE);
        ...
        assertThat(testLocation.getUwi()).isEqualTo(UPDATED_UWI);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE);
